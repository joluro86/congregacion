...
class Congregacion(models.Model):
    numero = models.IntegerField(
        verbose_name='Número de congregación', unique=True, primary_key=True)
    nombre = models.CharField(verbose_name='Nombre', max_length=100)
    municipio = models.CharField(
        verbose_name='Municipio o Ciudad', max_length=200)
...
class Grupo(models.Model):
    numero = models.IntegerField(
        verbose_name='Número', unique=True, primary_key=True)
    superintendente = models.ForeignKey(
        Superintendente, on_delete=models.CASCADE)
    congregacion = models.ForeignKey(Congregacion, on_delete=models.CASCADE)
    auxiliar = models.CharField(
        verbose_name='Auxiliar', null=True, blank=True, max_length=200)
...
class Precursorado(models.Model):
    precursorado = models.CharField(
        verbose_name='Precursorado', max_length=100)
...
class Publicador(models.Model):
    ...
    sexo = models.CharField(
        verbose_name='Sexo', choices=choices.sexo, default='----', max_length=50)
